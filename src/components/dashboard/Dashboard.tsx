...
const Dashboard: React.FC = () => {
    ...
    const projectProgressData: ChartData[] = projects.map((p: Project) => ({
        name: p.name?.substring(0, 15) || 'Unnamed',
        progress: Math.floor(Math.random() * 100),
        status: p.status || 'PENDING'
    }));

    const siteStatusData: ChartData[] = [
        ...
        <div className="dashboard">
                        ...
                        <ResponsiveContainer width="100%" height={300}>
                            <PieChart>
                                <Pie
                                    ...
                                    dataKey="value"
                                >
                                    {siteStatusData.map((_entry: ChartData, index: number) => (
            ...
            <div className="recent-sites-card">
                ...
                <div className="recent-sites-list">
                    {sites.slice(0, 5).map((site: SiteMasterlist) => (
